...
#define IOTJS_MAGIC_STRING_COMPILENATIVEPTR "compileModule"
...
#define IOTJS_MAGIC_STRING_DEBUGGER_SOURCE_COMPILE "debuggerSourceCompile"
#define IOTJS_MAGIC_STRING_DEBUGGER_WAIT_SOURCE "debuggerWaitSource"
