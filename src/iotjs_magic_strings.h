...
#if defined(ENABLE_MODULE_ADC) && ENABLE_MODULE_ADC
#define IOTJS_MAGIC_STRING_ADC "Adc"
#endif /* ADC */

#if defined(ENABLE_MODULE_BLE) && ENABLE_MODULE_BLE
...
#if defined(ENABLE_MODULE_DGRAM) && ENABLE_MODULE_DGRAM
...
#if defined(ENABLE_MODULE_GPIO) && ENABLE_MODULE_GPIO
...
#if defined(ENABLE_MODULE_HTTPS) && ENABLE_MODULE_HTTPS
...
#if defined(ENABLE_MODULE_I2C) && ENABLE_MODULE_I2C
#define IOTJS_MAGIC_STRING_SETADDRESS "setAddress"
#endif

#if defined(ENABLE_MODULE_PWM) && ENABLE_MODULE_PWM
...
#if defined(ENABLE_MODULE_SPI) && ENABLE_MODULE_SPI
